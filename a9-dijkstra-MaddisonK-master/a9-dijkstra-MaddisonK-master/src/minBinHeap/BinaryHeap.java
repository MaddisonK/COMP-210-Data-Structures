...
public interface BinaryHeap <V,P extends Comparable<P>> {
    ...
    /**
     * Create new PrioritizedImpl object and insert it into the heap
     * @param value
     * @param priority
     */
    ...
    Prioritized<V,P> getMin();

    /**
     * Retrieves contents of heap as an array.
     * @return array of Prioritized objects in the order stored in the heap
     */
